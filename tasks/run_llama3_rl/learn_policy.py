...
def get_llama3_output(client, prompt, args):
    job = client.submit(prompt, return_full_text=False, max_new_tokens=args.max_tokens, top_p=args.top_p, do_sample=False)
    return job.result()[0]
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='llama3_rl')
...
if __name__ == '__main__':
    ...
    client = LlamaClient(args.url, template=TEMPLATE01)
